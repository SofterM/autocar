  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <div>
          <h4 className="text-sm font-medium text-gray-500 mb-1">สถานะ</h4>
          <div className="flex items-center gap-3">
            ...
            <select
              value={repair.status}
              onChange={(e) => handleStatusOrCategoryChange(e.target.value as Repair['status'])}
    ...
    <div className="flex items-center gap-3">
        ...
        <select
            ...
            onChange={(e) => {
                ...
                handleStatusOrCategoryChange(undefined, newCategory);
            }}
            className="text-sm border-gray-300 rounded-lg flex-1"
            disabled={isLoading}
        >
        ...
        <div className="border rounded-lg overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between p-4 sm:px-6 sm:py-4 border-t bg-gray-50 gap-4 sm:gap-0 rounded-b-2xl">
            ...
            <div className="flex gap-3 sm:items-start">
              <button
                onClick={() => handleStatusOrCategoryChange()}
                disabled={isLoading}
